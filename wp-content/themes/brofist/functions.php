...
function brofist_load_scripts()
{
    ...
    wp_register_style('more', get_stylesheet_directory_uri() . '/assets/css/css/more.css', array(), null);
...
pll_register_string('Cookie.', 'Cookie.');
pll_register_string('By using this website, you automatically accept that we use cookies.', 'By using this website, you automatically accept that we use cookies.');
